 ...
 * @param[out] offset Byte offset of the interface descriptor relative to the start of the configuration descriptor. Can
 * be NULL.
 ...
 * @param[out] offset Byte offset of the endpoint descriptor relative to the start of the configuration descriptor. Can
 * be NULL
 * @return const usb_ep_desc_t* Pointer to endpoint descriptor, NULL if not found.
 */
