...
class SdSpi : public spi::SPIDevice<spi::BIT_ORDER_MSB_FIRST, spi::CLOCK_POLARITY_LOW, spi::CLOCK_PHASE_LEADING,
 ...
 public:
  ...
  void set_frequency(float frequency) { this->frequency_ = (int) frequency; }
 ...
 protected:
  ...
  int frequency_{400}; // Default to 400kHz if not set, or we can default to 20000 and let loop handle it
